...
Kubo now stores a subset of connected peers as backup bootstrap nodes ([kubo#8856](https://github.com/jmfrank63/kubo/pull/8856)).
These nodes are used in addition to the explicitly defined bootstrappers in the
[`Bootstrap`](https://github.com/jmfrank63/kubo/blob/master/docs/config.md#bootstrap) configuration.
...
was only available in LAN contexts with [mDNS peer discovery](https://github.com/jmfrank63/kubo/blob/master/docs/config.md#discoverymdns)
enabled.
...
[`Gateway.DeserializedResponses`](https://github.com/jmfrank63/kubo/blob/master/docs/config.md#gatewaydeserializedresponses)
configuration flag.
...
Rationale can be found in [kubo#9913](https://github.com/jmfrank63/kubo/pull/9913).
...
- github.com/jmfrank63/kubo:
  ...
  -  ([ipfs/kubo#9981](https://github.com/jmfrank63/kubo/pull/9981))
  -  ([ipfs/kubo#9960](https://github.com/jmfrank63/kubo/pull/9960))
  -  ([ipfs/kubo#9936](https://github.com/jmfrank63/kubo/pull/9936))
