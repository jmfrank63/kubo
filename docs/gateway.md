...
[config](https://github.com/jmfrank63/kubo/blob/master/docs/config.md#gateway)
documentation, including a list of common [gateway recipes](https://github.com/jmfrank63/kubo/blob/master/docs/config.md#gateway-recipes).
...
`go-get=1` parameter. See [PR#3964](https://github.com/jmfrank63/kubo/pull/3963)
for details</sub>
...
Support for user-provided IPLD selectors is tracked in https://github.com/jmfrank63/kubo/issues/8769.
