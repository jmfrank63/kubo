...
import (
	...
	repo "github.com/jmfrank63/kubo/repo"
	"github.com/jmfrank63/kubo/repo/common"
	dir "github.com/jmfrank63/kubo/thirdparty/dir"
	...
	serialize "github.com/jmfrank63/kubo/config/serialize"
	"github.com/jmfrank63/kubo/repo/fsrepo/migrations"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/jmfrank63/kubo/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/jmfrank63/kubo/issues/8088 for more details).
